<h1 align="center">Tabs In Compose</h1> 

<p align="center">
This app was created to learn more about Android compose using TabRow.
</p>
...
```bash
git clone https://github.com/munbonecci/TabsInCompose.git
```
